`WPScan CLI` tool uses a database of 38,514 [[WordPress]] vulnerabilities to check [[WordPress]] site for any vulnerabilities in any of its plugins, login credentials, etc.
...
Usage: wpscan [options]
    ...
    -e, --enumerate [OPTS]                        Enumeration Process
        ...
        --timthumbs-list FILE-PATH                List of timthumbs' location to use
                                                  Default: /home/theycallmemuzz/.wpscan/db/timthumbs-v3.txt
        ...
        --config-backups-list FILE-PATH           List of config backups' filenames to use
                                                  Default: /home/theycallmemuzz/.wpscan/db/config_backups.txt
        ...
        --db-exports-list FILE-PATH               List of DB exports' paths to use
                                                  Default: /home/theycallmemuzz/.wpscan/db/db_exports.txt
